...
try 
{
    ...
    if ($itemJson) 
    {
        ...
        // Actualizar el registro con la información del locker
        $registroCompleto = actualizarRegistroLocker($registroCompleto, 1);
        ...
        echo json_encode([
            'status'              => 'success', 
            'message'             => 'Locker entregado correctamente',
            'id'                  => $clvuni,
            'turno'               => $turno,
