...
$(function(){
    $('.datatable').each(function(){
        ...
        search_input.attr('placeholder', 'Buscar por { Matr&iacute;cula | Nombre }')
        search_input.addClass('form-control input-small buscar')
        search_input.css('width', '300px')
 
        // SEARCH CLEAR - Use an Icon
        var clear_input = datatable.closest('.dataTables_wrapper').find('div[id$=_filter] a');
        clear_input.html('<i class="glyphicon glyphicon-remove-circle"></i>')
